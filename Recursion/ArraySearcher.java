package Recursion;
//A class for searching an already sorted arry of integers
public class ArraySearcher 
{
    ...
    */
    ...
    /*
        If the target is in the array, returns the index of an occurrence of target. Returns -1 if targt is no in the array.
    */
    public int find(int target)
    {
        return binarySearch(target, 0, a.length -1);
    }
    //Uses a binary search to search for target in a[first] through
    //a[last] inclusive. Rerturns the index of target if target 

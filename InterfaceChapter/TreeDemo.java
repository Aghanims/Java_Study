...
/*
    A program that draw a fir tree composed of a triangle and a rectangle, both drawn using keyboard characters.
*/
public class TreeDemo 
{
    ...
    private static void drawTree(int topWidth, int bottomWidth, int bottomHeight)
    {

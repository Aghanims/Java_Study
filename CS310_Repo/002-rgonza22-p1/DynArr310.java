...
public class DynArr310<T> 
{
	...
	/**
	 * Constructor for initizalizing dynamic array of size 2
	 */
	...
	/**
	 * Contructor that accepts arguments for customizing initial size of dynamic array.
	 * 
	 * @param initCap is the customized size of the array. Since the minimum cap of the array is 2
	 * the value of this argument must be greater than 2.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * The total count of how many elements in the array exists.
	 * 
	 * @return the the count of elements that exists inside the array.
	 */
	public int size() 
	{	
	 ...
	 * 
	 * @return the count of all elements that exists inside the dynamic array
	 */
	public int capacity() 
	{ 
	...
	/**
	 * Modyfying the element at index of the array to a different value
	 * 
	 * @param index the location where the desired va
	 * @param value
	 * @return
	 */
	...
	/**
	 * Access the element of the spcified index
	 * 
	 * @param index
	 * @return
	 */
	...
	/**
	 * Insert a value at the specified inces
	 * 
	 * @param index location on where to place the value
	...
	/**
	 * Returns the element at the specified index from the dynamic array.
	 * 

...
public class DateParser 
{
   public static int getMonthAsInt(String monthString) 
   {
    ...
    public static void main(String[] args) 
    {
      ...
      //Read dates from input, parse the dates to find the ones  in the correct format, and output in m/d/yyyy format
      // Ex: March 1, 1990 --> 3/1/1990
        //  April 2 1995 --> 12/13/2003

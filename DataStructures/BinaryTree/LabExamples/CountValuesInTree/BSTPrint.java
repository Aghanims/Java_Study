...
class BSTPrint 
{
    public static String treeToString(TreeNode subtreeRoot) 
    {
       if (subtreeRoot == null) 
       {
          return "(empty tree)";
    ...
    private static String[] treeToLines(TreeNode subtreeRoot) 
    {
       if (subtreeRoot == null) {
          return new String[0];
       }
       ...
       String rootString = "[" + subtreeRoot.getData() + "]";
       ...
       if (rightLines.length > 0) 
       {
          ...
          // right of the root
          indentNeeded = Math.max(0,leftLines[0].length() + rootString.length() - rightLines[0].indexOf('['));
       }
